        ...
        <div class="header-title">
          ...
          <div id="menuprincipale-bar" role="menuBar">
              <ul id="menuprincipale">
                  ...
                  <li class="dropdown"><a aria-haspopup="true" aria-expanded="false" tabindex="0" class="active">Luoghi</a>
                      <ul class="dropdown-content button-right" role="menu">
                          ...
                          <li role="none" class="active"><a href="praglia.php" tabindex="-1" role="menuitem">Abbazia di Praglia</a></li>
