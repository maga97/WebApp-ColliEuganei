        ...
        <div class="form">
            <form method="post" action="login.php" class="log-form">
                ...
                <div class="log-field-container">
                    ...
                    <input type="text" id="username" name="email" accesskey="n" aria-required="true" maxlength="28"/>
                </div>
                <div class="log-field-container">
                    <label for="password" xml:lang="en" class="log-label">Password: </label>
                    <input type="password" id="password" aria-required="true" name="password" accesskey="p"
                           maxlength="32"/>
                </div>
