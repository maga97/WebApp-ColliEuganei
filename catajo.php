...
<div id="container">
    ...
    <div id="content">
        ...
        <div class="section">
            ...
            <div class="row">
                <img class="responsive-image history-picture float-right" src="assets/img/catajo-XVIIIsec.jpg"
                     alt="Il Castello nel XVIII secolo"/>
                <p class="text">
                    Il castello del Catajo, situato nei pressi di Battaglia Terme, &egrave; un imponente palazzo
                    cinquecentesco,
            ...
            <h2>Descrizione</h2>
            <div class="row">
                <img class="responsive-image history-picture float-right" src="assets/img/affreschi2.jpg"
                ...
                <p class="text">
                    Nel grande salone affrescato spicca l'albero genealogico della famiglia Obizzi, dal capostipite
                    Obicio I
