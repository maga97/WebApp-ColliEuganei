...
che avvisi l'utente di nuovi eventi dopo la loro creazione da parte dei responsabili e la possibilità per gli utenti di commentarli solo dopo l'avvenuta partecipazione.
\subsection{Front end}
A lato front end è importante l'accessibilità e l'interazione con l'utente tramite
un'interfaccia responsive che richiami i colori della natura, pertanto dev'essere
