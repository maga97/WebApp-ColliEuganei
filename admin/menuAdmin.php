    ...
    <ul id="menuprincipale">
        ...
        <li class="dropdown"><a aria-haspopup="true" tabindex="0">Gestione gite</a>
            <ul class="dropdown-content" role="menu" id="dropdown-trip">
                ...
                <?php else: ?>
                    <li><a href="add-trip.php" tabindex="0" role="menuitem">Aggiungi gita</a>
                    </li>
                <?php endif; ?>
                <?php if ($nomepagina == "select-trip-modify.php"): ?>
                    <li class="active"><a href="select-trip-modify.php" tabindex="0" role="menuitem">Modifica gita</a>
                    </li>
                <?php else: ?>
                    <li><a href="select-trip-modify.php" tabindex="0" role="menuitem">Modifica gita</a>
                    </li>
                <?php endif; ?>
                <?php if ($nomepagina == "remove-trip.php"): ?>
                    <li class="active"><a href="remove-trip.php" tabindex="0" role="menuitem">Rimuovi gita</a></li>
                <?php else: ?>
                    <li><a href="remove-trip.php" tabindex="0" role="menuitem">Rimuovi gita</a>
                    </li>
                <?php endif; ?>
            </ul>
        </li>
        <li class="dropdown"><a aria-haspopup="true" tabindex="0">Gestione utente</a>
            <ul class="dropdown-content" role="menu">
                <?php if ($nomepagina == "add-admin.php"): ?>
                    <li class="active"><a href="add-admin.php" tabindex="0" role="menuitem">Aggiungi amministratore</a>
                    </li>
                <?php else: ?>
                    <li><a href="add-admin.php" tabindex="0" role="menuitem">Aggiungi amministratore</a>
                    </li>
                <?php endif; ?>
                <?php if ($nomepagina == "remove-admin.php"): ?>
                    <li class="active"><a href="remove-admin.php" tabindex="0" role="menuitem">Rimuovi
                            amministratore</a></li>
                <?php else: ?>
                    <li><a href="remove-admin.php" tabindex="0" role="menuitem">Rimuovi amministratore</a>
                    </li>
                <?php endif; ?>
            </ul>
        </li>
