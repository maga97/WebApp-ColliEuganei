    ...
    <div id="content">
        ...
        <div class="section">
            ...
            <p class="text">
                ...
                Carrara, Signori di Padova, nella prima metà del Trecento. L’imponente torre merlata, aveva una funzione
                di prima difesa nei numerosi attacchi da parte degli Scaligeri, Signori di Verona. Nella metà del
                Settecento la proprietà passa ai Conti Zaborra che ampliano notevolmente l’edificio, rimodernano l’ala
            ...
            <p class="text">
                ...
                austro-ungarica.
                Nelle stanze del poeta tutto è rimasto come allora perché voi possiate rivivere quei momenti e
            ...
            <h2>Il giardino</h2>
            <p class="text">
                Il giardino storico del Castello è un luogo incantevole tutto da vivere e visitare, passeggiando tra le
                rose e i suoi labirinti.
                Dal 1970 il Parco è stato oggetto di un accurato restauro con il censimento di tutte le specie botaniche
                ...
                Tra le piante più antiche una Lagestroemia Indica del 1700 e numerosi esemplari di Tilia cordata e
                Carpinus betulus ultra-centenari.
                Nel 2000 è stato creato un labirinto verde di 1200 mq, per raccontare il mito del volo di Icaro, senza
                dimenticare la funzione dei labirinti delle ville venete.
                Nel 2007 è sorto il labirinto del “Forse che Si Forse che No” per sottolineare il concetto dannunziano
                di doppio.
            </p>
            <h2>Il museo</h2>
            <div class="float-right">
            ...
            <p class="text">
                Dal 1970 la villa è stata oggetto di accurati restauri e ripensata nelle funzioni attuali principalmente
                come Museo del Volo. Inaugurato nel 1980, ripercorre l’intera storia del volo umano facendo perno
                sull’impresa dannunziana; a tale volo è dedicata la parte principale del Museo con le stanze abitate dal
                ...
                protagonisti per ripercorrere la più straordinaria impresa umana: il volo!
                Dal 2018, nel centenario del Volo su Vienna, isole multimediali immersive rendono la visita
                un’esperienza emozionale!
            </p>
        </div>
